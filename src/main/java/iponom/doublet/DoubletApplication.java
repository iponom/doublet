...
@Slf4j
public class DoubletApplication implements ApplicationRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(DoubletApplication.class, args);
    }
    ...
    public void run(ApplicationArguments applicationArguments) throws Exception {
        ...
        try {
            ...
            if (Files.isDirectory(path)) {
                ...
                log.warn("Searching has been finished. See " + resultFileName);
            } else {
                log.error(args.get(0) + " is not a directory");
            }
